        ...
        <div onClick={changeActive} className={classNames("animation-container turned", active && "click-animation")}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 239.181 239.181" className="bot bot_turned">
                <defs>
                    ...
                    <filter id="1b" x="0" y="0" width="239.181" height="239.181" filterUnits="userSpaceOnUse">
                        <feOffset dy="3" />
                    ...
                    <linearGradient id="1d" x1="0.131" y1="0.278" x2="1.109" y2="1.209" gradientUnits="objectBoundingBox">
                    ...
                    <filter id="1e" x="-56" y="-65" width="123.746" height="121.34" filterUnits="userSpaceOnUse">
                        <feOffset dy="3"/>
                    ...
                    <linearGradient id="1g" x1="0.537" y1="0.298" x2="0.663" y2="1" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#0b5b90"/>
                        <stop offset="0.269" stopColor="#65c4ff"/>
                        <stop offset="0.755" stopColor="#fff"/>
                        <stop offset="1" stopColor="#fff"/>
                    </linearGradient>
                    <filter id="1h" x="-70" y="-82" width="135.599" height="164.336" filterUnits="userSpaceOnUse">
                        <feOffset dy="3"/>
                    ...
                    <radialGradient id="1j" cx="0.233" cy="0.5" r="0.496" gradientTransform="matrix(-0.093, -0.996, 1.699, -0.16, -0.768, 0.654)" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#0166ba"/>
                        <stop offset="0.3" stopColor="#2795f4"/>
                        <stop offset="1" stopColor="#93d5ff"/>
                    </radialGradient>
                    <radialGradient id="1k" cx="0.5" cy="0.5" r="0.5" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#fff"/>
                        <stop offset="0.665" stopColor="#fff"/>
                        <stop offset="1" stopColor="#bce7ff"/>
                    </radialGradient>
                    <radialGradient id="1l" cx="0.4" cy="0.3" r="0.506" gradientTransform="translate(0.081 -0.069) rotate(8.622)" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#fff"/>
                        <stop offset="0.785" stopColor="#fff" stopOpacity="0"/>
                        <stop offset="1" stopColor="#fff" stopOpacity="0"/>
                    </radialGradient>
                    <linearGradient id="1m" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#9dd2ff"/>
                        <stop offset="1" stopColor="#00a8ff"/>
                    </linearGradient>
                    <linearGradient id="1n" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                    ...
                    <radialGradient id="1o" cx="0.5" cy="0.5" r="0.986" gradientTransform="translate(0.182 0.17) scale(0.637 0.66)" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#21bbf4"/>
                        <stop offset="0.837" stopColor="#58b2ff"/>
                        <stop offset="1" stopColor="#0065bc"/>
                    </radialGradient>
                    <linearGradient id="1r" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#d5f0ff" stopOpacity="0.867"/>
                        <stop offset="1" stopColor="#739eff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="1s" x1="0.5" y1="0.945" x2="0.5" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#33c0ff"/>
                        <stop offset="0.695" stopColor="#0d69af"/>
                        <stop offset="1" stopColor="#004c85"/>
                    </linearGradient>
                    <filter id="1t" x="119.056" y="130.739" width="33.842" height="26.634" filterUnits="userSpaceOnUse">
                        <feGaussianBlur stdDeviation="1" result="u"/>
                        <feFlood floodColor="#02a7ff" floodOpacity="0.776"/>
                        <feComposite operator="in" in2="u"/>
                        <feComposite in="SourceGraphic"/>
                    </filter>
                    <filter id="1v" x="-25" y="-30" width="43.432" height="41.527" filterUnits="userSpaceOnUse">
                        <feGaussianBlur stdDeviation="2" result="w"/>
                        <feFlood floodColor="#fff"/>
                        <feComposite operator="in" in2="w"/>
                        <feComposite in="SourceGraphic"/>
                    </filter>
                    <filter id="1x" x="-22" y="-35" width="42.277" height="47.525" filterUnits="userSpaceOnUse">
                        <feGaussianBlur stdDeviation="3" result="y"/>
                        <feFlood floodColor="#fff"/>
                        <feComposite operator="in" in2="y"/>
                        <feComposite in="SourceGraphic"/>
                    </filter>
                    <linearGradient id="1z" x1="0.485" y1="0.266" x2="0.809" y2="1.019" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#f5fcff"/>
                        <stop offset="1" stopColor="#ccefff"/>
                    </linearGradient>
                    <filter id="1aa" x="35.893" y="104.929" width="54.527" height="74.546" filterUnits="userSpaceOnUse">
                        <feOffset dy="1"/>
                    ...
                    <radialGradient id="1ac" cx="0.34" cy="0.353" r="0.392" gradientTransform="matrix(0.741, 0.671, -0.509, 0.562, 0.336, -0.179)" gradientUnits="objectBoundingBox">
                    ...
                    <linearGradient id="1ad" x1="0.904" y1="0.994" x2="0.135" y2="-0.003" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="#fff"/>
                        <stop offset="0.266" stopColor="#f8fcff"/>
                        <stop offset="1" stopColor="#2fa4ff"/>
                    </linearGradient>
                    <radialGradient id="1gradient" cx="0.5040860175490379" cy="0.7225980346202849" r="0.528" spreadMethod="pad" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor="rgb(3,75,129)"/>
                        <stop offset="1" stopColor="rgb(3,75,129)"/>
                    </radialGradient>
                    <radialGradient id="1gradient2" cx="0.5040860175490379" cy="0.7225980346202849" r="0.528" spreadMethod="pad" gradientUnits="objectBoundingBox">
                ...
                <g id="bot-wrap" transform="matrix(1, 0, 0, 1, 38.64099999999999, 32.66300000000000)">
                    <g transform="translate(1.636 1.87)">
                        ...
                        <path d="M65.591,0A65.591,65.591,0,1,1,0,65.591,65.591,65.591,0,0,1,65.591,0Z" transform="translate(13.723 16.466)" fill="url(#1k)"/>
                        ...
                        <path id="chin" d="M31.113000,-0.250000C46.853000,-0.250000,65.234000,-1.450000,65.234000,3.523000C65.234000,8.496000,44.240000,18,28.500000,18C12.760000,18,1.153000,9.623000,1.153000,4.652000C1.153000,-0.319000,15.373000,-0.250000,31.113000,-0.250000Z" transform="matrix(1, 0, 0, 1, 50.33900000000000, 133.47499999999999)" fill="url(#1l)" />
                    </g>
                    <g transform="translate(23.83 7.344)">
                        <g transform="translate(0 12.481)" opacity="0.518">
                            <path d="M11.879,59.229s2.7-28.39,23.6-37.056,63.745-10.014,77.808,7.535,25.266,46.615,15.112,61.68S102.938,87.361,85.112,88.5,55.543,103.775,29.27,98.521,11.879,59.229,11.879,59.229Z" transform="translate(-10.433 -12.086)" opacity="0.395" fill="url(#1m)"/>
                            <path d="M10.881,67.45c-.593-9.5,4.981-38.121,30.129-48.362s52.977-6.689,69.4,8.547c16.258,15.084,28.943,42.772,18.4,62.993.028-.038-.1.135-.224.306-12.717,17.086-28.2-4.924-44.982-1.971-23.039,4.055-29.73,15-51.563,10.246S11.475,76.947,10.881,67.45Z" transform="translate(-10.03 -13.273)" fill="url(#1n)"/>
                        </g>
                        <g transform="translate(2.332 14.733)">
                            <path d="M14.183,23.378C26.05,7.955,75.77,6.2,96.783,16.027c21.539,14.151,28.283,45.079,21.981,59.779-6.356,12.082-13.1,10.379-17.959,9.353s-11.6-7.134-24.728-7.416-18.353,3.213-27.8,6.286S27.143,88.418,19.05,85.16C-6.534,75.454,2.316,38.8,14.183,23.378Z" transform="translate(-2.533 -5.236)" fill="url(#1o)"/>
                            <path d="M12.707000,68.730000C11.844000,63.382000,11.567000,46.368000,22.526000,30.888000C38.181000,9.119000,89.863000,9.333000,107.400000,27.715000C107.372000,27.681000,107.522000,27.853000,107.668000,28.027000C123.939000,47.271000,130.920000,70.627000,119.622000,87.086000C108.324000,103.545000,99.052000,83.334000,78.072000,85.100000C57.092000,86.866000,54.462000,95.500000,38.592000,93.300000C22.722000,91.100000,13.460000,79.064000,12.707000,68.730000Z" transform="matrix(1 0 0 1 -10.05600000000000 -14.22500000000000)" opacity="1" fill="url(#1gradient)" />
                            <g id="forhead" transform="translate(71,80)">
                                <g id="forhead-scale" transform="scale(1,1)">
                                    <path d="M12.707000,68.730000C11.844000,63.382000,11.567000,46.368000,22.526000,30.888000C38.181000,9.119000,89.863000,9.333000,107.400000,27.715000C107.372000,27.681000,107.522000,27.853000,107.668000,28.027000C123.939000,47.271000,130.920000,70.627000,119.622000,87.086000C108.324000,103.545000,99.052000,83.334000,78.072000,85.100000C57.092000,86.866000,54.462000,95.500000,38.592000,93.300000C22.722000,91.100000,13.460000,79.064000,12.707000,68.730000Z" transform="translate(-80.665030,-93.466082)" fill="url(#1gradient2)" stroke="none" strokeWidth="1"/>
                                </g>
                            </g>
                        </g>
                        <path d="M38.051,12.861A15.562,15.562,0,0,1,40,20.5c0,11.322-8.054,20.016-19.1,20.016-7.566,0-15.052-3.822-18.589-10.44.19.069,6.753-7.343,16.276-11.343A104.37,104.37,0,0,1,38.051,12.861Z" transform="translate(7.146 -1)" opacity="0.782" fill="url(#1l)"/>
                        <path d="M40.338.039c23.466,0,37.843,10.921,41.57,18.525,3.783,8.826-15.426,16.249-41.57,16.406C17.81,35.107-2.18,26.95-.462,18.329,1.725,10.215,18.8.039,40.338.039Z" transform="translate(17.736 17.683)" opacity="0.873" fill="url(#1r)"/>
                    </g>
                    ...
                    <g id="eyes" transform="translate(90.984131,85.225580) scale(1,1)">
                        <g transform="translate(-90.984131,-85.225580)">
                            <g id="eye-right" transform="translate(120.392590,85.205491) scale(1,1)" filter="url(#1v)">
                            ...
                            <g id="eye-left" transform="translate(64.980469,85.205491) scale(1,1)" filter="url(#1x)">
                    ...
                    <g transform="translate(1.881 77.266)">
                        <g transform="matrix(1, 0, 0, 1, -40.52, -109.93)" filter="url(#1aa)">
                            <path d="M6.395.88c2.569-2.143,7.145-.43,8.355,5.747.282,1.436,1.1,16.728,2.306,29.263,1.118,11.626,2.91,23.022.814,24.186C13.611,62.442,2.538,36.449.462,23.136S3.826,3.023,6.395.88Z" transform="translate(41.89 117.89) rotate(-25)" fill="url(#1z)"/>
                        </g>
                        <path d="M8.506.018c1.657.219,3.279,3.759,3.252,8.74s1.327,29.742-.063,31.365S2.99,30.926.477,17.238,6.094-.3,8.506.018Z" transform="translate(0 9.313) rotate(-25)" fill="url(#1ac)"/>
                        <path d="M2.121,34.986c2.774-1.98,1.139-7.253,1.136-12.937A164.9,164.9,0,0,0,1.784.333C1.315-2.964-.011,19.184,0,25.115S.43,35.664,2.121,34.986Z" transform="translate(26.67 37.361) rotate(150)" opacity="0.35" fill="url(#1ad)"/>
                    </g>
                </g>
            </svg>
        </div>
