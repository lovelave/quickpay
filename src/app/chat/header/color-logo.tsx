...
export const ColorLogo = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 135.788 34.801" className="img">
            <defs>
                <linearGradient id="wa" x1="0.944" y1="0.052" x2="0.583" y2="0.523" gradientUnits="objectBoundingBox">
                    <stop offset="0" stopColor="#c1ecff"/>
                    <stop offset="1" stopColor="#64cfff"/>
                </linearGradient>
                <radialGradient id="wb" cx="0.866" cy="0.565" r="0.803" gradientTransform="translate(0 0.158) scale(1 0.72)" gradientUnits="objectBoundingBox">
                    <stop offset="0" stopColor="#74d5ff"/>
                    <stop offset="1" stopColor="#91ddff" stopOpacity="0.059"/>
                </radialGradient>
                <linearGradient id="wc" x1="0.012" y1="0.051" x2="0.955" y2="0.727" gradientUnits="objectBoundingBox">
                    <stop offset="0" stopColor="#9fe9ff"/>
                    <stop offset="0.68" stopColor="#00b1ff"/>
                    <stop offset="1" stopColor="#31597b"/>
                </linearGradient>
                <linearGradient id="wd" x1="0.839" y1="0.015" x2="0.432" y2="0.959" gradientUnits="objectBoundingBox">
                    <stop offset="0" stopColor="#49caff"/>
